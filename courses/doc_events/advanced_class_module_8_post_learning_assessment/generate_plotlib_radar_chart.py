...
def get_categories_key():
    doc = frappe.get_doc("DocType", "Advanced Class Module 8 Post Learning Assessment")
...
def execute(doc, method):
    ...
    final_filepath = '{}/sites/{}/public/files/post-test-{}.png'.format(frappe.utils.get_bench_path(), frappe.utils.get_site_path().replace('./',''), salt)
    fig.write_image(final_filepath)

    doc.chart_image = "/files/post-test-{}.png".format(salt)